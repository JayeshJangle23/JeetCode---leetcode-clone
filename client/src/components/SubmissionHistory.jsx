  ...
  useEffect(() => {
    const fetchSubmissions = async () => {
      try {
        ...
        // Handle cases where backend sends either an array or object
        const data = response.data;

        // Check if data itself is an array or nested inside a property
        if (Array.isArray(data)) {
          setSubmissions(data);
        } else if (Array.isArray(data.submissions)) {
          setSubmissions(data.submissions);
        } else {
          console.error("Unexpected submissions response:", data);
