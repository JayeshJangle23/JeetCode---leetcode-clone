...
const ProblemPage = () => {
  ...
  // Removed unused handleSubmit from useForm
 ...
 useEffect(() => {
    const fetchProblem = async () => {
      ...
      try {
        ...
        const matchedLang = response.data?.startCode?.find(sc => sc.language === langMap[selectedLanguage]);
        const initialCode =matchedLang.initialCode || "";
                ...
                <div>
                  ...
                  {isAuthenticated ? (
                    <div className="text-gray-500">
                      <SubmissionHistory key={`${problemId}-${submitResult ? 'updated' : 'initial'}`} problemId={problemId} />
                    </div>
                  ) : (
